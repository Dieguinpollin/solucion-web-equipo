...
Project Manager (Diego): Me encargo de que el repositorio esté en orden, gestionar los issues y revisar que los cambios de mis compañeros se integren bien a la rama principal (main).


Desarrollador Front 1 (Gael): Se encarga de la estructura general, el menú de navegación y de armar la tabla donde se verán todas las mascotas.


Desarrollador Front 2 (Taylor): Responsable de crear el formulario para los adoptantes, las secciones de requisitos y el pie de página.
